...
- Load an image from a file picker, drag and drop, or paste it from the clipboard.
...
2. Load an image with the file picker or drag and drop, or paste one with `Ctrl+V` / `Cmd+V`.
